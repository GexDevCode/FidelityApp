...
export function Product(props: ProductItem){
    return <View style={styles.container}>
        ...
        </View>
        {
            props.canClaim 
            ?
                <View style={styles.columnCta}>
                <TouchableOpacity activeOpacity={0.9} style={styles.buttonCta} onPress={props.onPress}><Text style={styles.textCta}>Ottieni!</Text></TouchableOpacity>
                </View>
                :
            null
        }
